...
class PaymentSecurityCard @JvmOverloads constructor(
    context: Context,
    ...
    init {
        ...
        val titleView = TextView(context).apply {
            text = "256-Bit Encrypted & PCI DSS Secure"
        ...
        val descView = TextView(context).apply {
            text = "Your payment credentials are end-to-end encrypted and verified via Razorpay."
